...
const CognitoIcon = (props) => {
  return (
    <SvgIcon {...props} viewBox="0 0 75 75">
      <g id="Reference">
        <rect id="Red_Light_BG" data-name="Red Light BG" style={{ fill: '#d6242d' }} width="75" height="75" />
        <g id="Product_Icon" data-name="Product Icon">
          ...
          <rect style={{ fill: '#fff' }} x="16.77" y="31.95" width="10.98" height="2" />
          <rect style={{ fill: '#fff' }} x="16.77" y="36.95" width="6.98" height="2" />
          <rect style={{ fill: '#fff' }} x="25.77" y="36.95" width="2.98" height="2" />
          <path style={{ fill: '#fff' }} d="M51.78,35.65h0v0Z" />
          <path style={{ fill: '#fff' }} d="M52.14,60.05a10.11,10.11,0,1,1,1.22-20.14h0a10.12,10.12,0,0,1,6.46,16.61,10.47,10.47,0,0,1-3.37,2.57A10.19,10.19,0,0,1,52.14,60.05Zm0-18.22a8,8,0,0,0-3.69.9,8.11,8.11,0,0,0,7.16,14.55,8.2,8.2,0,0,0,2.71-2.07,8.11,8.11,0,0,0-5.19-13.32h0A8.22,8.22,0,0,0,52.12,41.83Z" />
          <path style={{ fill: '#fff' }} d="M50.55,54.2h0a1,1,0,0,1-.71-.29l-3.23-3.23L48,49.27l2.52,2.52,5.7-5.71,1.42,1.42-6.42,6.41A1,1,0,0,1,50.55,54.2Z" />
          <path style={{ fill: '#fff' }} d="M51.78,35.65h0v0Z" />
        </g>
      </g>
    </SvgIcon>
