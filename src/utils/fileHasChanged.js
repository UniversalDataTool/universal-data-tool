export default (objectOfRef, objectToCheck) => {
    ...
    if  (typeof objectToCheck.id !== "undefined"){
        if(typeof objectOfRef.id=== "undefined")
            resultSet.id=true
        else if(objectToCheck.id !== objectOfRef.id)
            resultSet.id=true
    }
    ...
    if  (typeof objectToCheck.content !== "undefined"){
        if(typeof objectOfRef.content=== "undefined"){
            ...
            if  (typeof objectToCheck.content.interface !== "undefined"){
                if(typeof objectOfRef.content.interface=== "undefined"){
                ...
                else if(objectToCheck.content.interface !== objectOfRef.content.interface){
                    ...
                    if(typeof objectToCheck.content.interface.type !== "undefined"){
                        ...
                        else if(objectToCheck.content.interface.type !== objectOfRef.content.interface.type){
                            resultSet.content.interface.type=true
                        }
                    }
                    //Vérifie si la donnée availableLabels a changé
                    if(typeof objectToCheck.content.interface.availableLabels !== "undefined"){
                        if(typeof objectOfRef.content.interface.availableLabels=== "undefined"){
                            resultSet.content.interface.availableLabels=true
                        }
                        else if(objectToCheck.content.interface.availableLabels !== objectOfRef.content.interface.availableLabels){
                            resultSet.content.interface.availableLabels=true
                        }
                    }
                    //Vérifie si la donnée regionTypesAllowed a changé
                    if(typeof objectToCheck.content.interface.regionTypesAllowed !== "undefined"){
                        if(typeof objectOfRef.content.interface.regionTypesAllowed=== "undefined"){
                            resultSet.content.interface.regionTypesAllowed=true
                        }
                        else if(objectToCheck.content.interface.regionTypesAllowed !== objectOfRef.content.interface.regionTypesAllowed){
                            resultSet.content.interface.regionTypesAllowed=true
                        }
                    }
                }
            ...
            if  (typeof objectToCheck.content.taskData !== "undefined"){
                ...
                else if(objectToCheck.content.taskData !== objectOfRef.content.taskData){
                    resultSet.content.taskData=true
                }
            }
            ...
            if  (typeof objectToCheck.content.taskOutput !== "undefined"){
                ...
                else if(objectToCheck.content.taskOutput !== objectOfRef.content.taskOutput){
                    resultSet.content.taskOutput=true
                }
            }
        }
    ...
    if  (typeof objectToCheck.mode !== "undefined"){
        if(typeof objectOfRef.mode=== "undefined")
            resultSet.mode=true
        else if(objectToCheck.mode !== objectOfRef.mode)
            resultSet.mode=true
    }

    // Vérifie si la donnée fileName existe et est changé
    if  (typeof objectToCheck.fileName !== "undefined"){
        if(typeof objectOfRef.fileName=== "undefined")
            resultSet.fileName=true
